...
def build_tft(config):
    ...
    tft = TemporalFusionTransformer(  # refactor this to config.py, then try to break it down to a BaseModelWithCovariates -> BaseModel ....... probbaly put this above build time series dataset
        max_encoder_length=config["max_encoder_len"],
        static_categoricals=config["static_categoricals"],
        static_reals=config["static_reals"],
        time_varying_reals_encoder=time_varying_known_reals
        + time_varying_unknown_reals,
        time_varying_reals_decoder=time_varying_known_reals,
        x_reals=config["static_reals"]
        + time_varying_known_reals
        + time_varying_unknown_reals,
